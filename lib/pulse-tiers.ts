...
export const PULSE_TIERS = {
  ...
  mundial_pack: {
    ...
    name: 'Paquete Pulse (5)',
    nameEn: 'Pulse Pack (5)',
    priceMXN: 50000,
    fundPercent: 0.4,
    platformPercent: 0.6,
    durationLabelEs: '5 Pulses · presencia destacada',
    durationLabelEn: '5 Pulses · featured presence',
    popular: false,
    contactOnly: false,
    featuresEs: [
      '5 Pulses para tu agenda de investigación',
      'Destacado en plataforma en cada Pulse',
      'Tarjeta de patrocinador en cada Pulse',
      'Mención en newsletter y CEO digest',
      '40% → Fondo Consciente',
    ],
    featuresEn: [
      '5 Pulses for your research agenda',
      'Featured placement on each Pulse',
      'Branded sponsor card on each Pulse',
      'Mentioned in newsletter and CEO digest',
      '40% → Conscious Fund',
    ],
    bestForEs: 'Marcas que quieren presencia sostenida en la plataforma',
    bestForEn: 'Brands seeking sustained platform presence',
    sponsorshipMonths: 3,
  },
  mundial_pack_founding: {
    id: 'mundial_pack_founding' as const,
    name: 'Paquete Fundador',
    nameEn: 'Founding Pack',
    priceMXN: 25000,
    fundPercent: 0.4,
    platformPercent: 0.6,
    durationLabelEs: '5 Pulses + reconocimiento permanente',
    durationLabelEn: '5 Pulses + permanent recognition',
    popular: false,
    contactOnly: false,
    featuresEs: [
      'Todo lo del Paquete Pulse (5 Pulses)',
    ...
    featuresEn: [
      'Everything in the Pulse Pack (5 Pulses)',
      'Permanent logo on homepage "Trusted Brands" row',
      'Lifetime recognition on /about',
      'Only 5 spots — 50% off',
      '40% → Conscious Fund',
    ],
    bestForEs: 'Las primeras 5 marcas fundadoras',
    bestForEn: 'The first 5 founding brands',
    sponsorshipMonths: 3,
  },
  enterprise: {
