    ...
    <div className="min-h-screen bg-[#0f1419] px-4 py-8 text-slate-100">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 max-w-none space-y-4 text-sm text-slate-300">
          <p>
            Este enlace privado te permite ver el rendimiento de tus Pulses sin iniciar sesión
            en la plataforma. Guárdalo en un lugar seguro.
          </p>
          <h2 className="text-lg font-semibold text-white">Métricas</h2>
          <ul className="list-disc space-y-1 pl-5 text-slate-400">
            <li>
              <strong className="text-slate-200">Pulses activos</strong>: Pulses con estado activo o en
              curso.
            </li>
            <li>
              <strong className="text-slate-200">Votos</strong>: total de votos registrados en tus Pulses
              vinculados.
            </li>
            <li>
          ...
          <p className="text-slate-400">
            ...
            Pulse. Desde cada tarjeta puedes descargar <strong className="text-slate-200">CSV</strong> con
            los votos (Pulse).
          </p>
          ...
          <p className="text-slate-400">
            ...
            para vincular Pulses existentes a tu cuenta o configurar nuevos patrocinios.
          </p>
        </div>
      </div>
    </div>
