        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="max-w-md mx-auto">
              <p className="text-cc-text-muted text-sm text-center mb-3">Your brand on a market card</p>
                ...
                {previewMarketId ? (
                  <>
                    ...
                    <div className="px-4 py-2 border-t border-cc-border bg-gray-800/80 flex items-center justify-between">
                      <span className="text-cc-text-muted text-xs">Sponsored by</span>
                  ...
                  <>
                    <div className="p-6 space-y-4">
                      ...
                      <div className="flex justify-between items-end">
                        <div>
                          <p className="text-cc-text-muted text-xs">Current crowd consensus</p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border border-cc-border bg-cc-card/80 rounded-xl p-6 text-center">
                ...
                <p className="text-cc-text-secondary text-sm mt-1">accurate at forecasting events</p>
                <p className="text-cc-text-muted text-xs mt-2">Polymarket, academic research</p>
              </div>
              <div className="border border-cc-border bg-cc-card/80 rounded-xl p-6 text-center">
                <p className="text-3xl md:text-4xl font-bold text-emerald-400">2.2B+</p>
                <p className="text-cc-text-secondary text-sm mt-1">World Cup viewers expected in 2026</p>
              </div>
              <div className="border border-cc-border bg-cc-card/80 rounded-xl p-6 text-center">
            ...
            {unsponsored.length === 0 ? (
              ...
              <>
                <div className="flex flex-wrap gap-2 mb-6">
                  <span className="text-cc-text-muted text-sm mr-2">Filter by category:</span>
                  <button
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border border-cc-border bg-cc-card/80 rounded-xl p-6">
                ...
                <p className="text-cc-text-secondary text-sm mt-1">matches at Estadio Azteca</p>
              </div>
              <div className="border border-cc-border bg-cc-card/80 rounded-xl p-6">
                <p className="text-3xl font-bold text-emerald-400">100K+</p>
                <p className="text-cc-text-secondary text-sm mt-1">fans at the Zócalo Fan Fest</p>
              </div>
              <div className="border border-cc-border bg-cc-card/80 rounded-xl p-6">
                <p className="text-3xl font-bold text-emerald-400">48</p>
                <p className="text-cc-text-secondary text-sm mt-1">nations, 1 city, your brand</p>
              </div>
            </div>
          </div>
        </section>
