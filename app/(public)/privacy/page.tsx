    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "Conservamos sus datos personales durante el tiempo necesario para cumplir con las finalidades descritas y las obligaciones legales aplicables. Los datos de votos se conservan para mantener la integridad del historial de la plataforma, salvo solicitud de eliminación."
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "We retain your personal data for the time necessary to fulfill the described purposes and applicable legal obligations. Vote data is retained to maintain platform history integrity, unless deletion is requested."
        },
        {
          title: "9. Minors",
