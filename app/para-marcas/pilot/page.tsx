...
/**
 * /para-marcas/pilot — entry tier ($1,500 MXN one-time) for the Conscious
 * Pulse product. Functionally identical to the previous /pulse/pilot;
 * only the URL changed (the old path now permanently redirects here so
 * existing emails / receipts / utm-tagged links continue to work).
 */
...
export default async function ParaMarcasPilotPage() {
    ...
    <div className="min-h-screen bg-[#0f1419] text-slate-100">
      <main className="mx-auto max-w-2xl px-4 py-16 sm:py-20">
        ...
        <div className="mt-10 text-center text-sm text-slate-400">
          ...
          <a href="/para-marcas#pulse-pricing" className="text-emerald-400 hover:underline">
