...
// Real brand partnerships will be displayed when available
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-7xl mx-auto px-4">
        {/* Testimonials - Only show if we have real testimonials */}
        ...
        {/* Brand Partners - Only show if we have real brand partnerships */}
        {brandLogos.length > 0 && (
          <div className="text-center">
            <motion.h3
