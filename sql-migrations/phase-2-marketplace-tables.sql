...
CREATE TRIGGER update_community_wallets_updated_at
BEFORE UPDATE ON public.community_wallets
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
DO $$
BEGIN
  RAISE NOTICE '✅ Phase 2 Marketplace tables created successfully!';
  RAISE NOTICE '📦 Created 7 tables: marketplace_modules, module_lessons, creator_applications, module_reviews, revenue_transactions, community_wallets, cart_items';
  RAISE NOTICE '🔒 RLS policies enabled for all tables';
  RAISE NOTICE '⏰ Auto-update triggers configured';
  RAISE NOTICE '🚀 Ready for Module Builder and Marketplace UI!';
END $$;
